...
export const CONSUMPTIONHOTEL_CHECKBOXES = [
  {
...
export const CheckBoxConsumptionHotel = ({ className, checked, ...props }) => {
  return (
...
CheckBoxConsumptionHotel.propTypes = {
  className: PropTypes.string,
  checked: PropTypes.bool.isRequired,
};

CheckBoxConsumptionHotel.defaultProps = {
  className: '',
};
